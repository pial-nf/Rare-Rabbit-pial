    ...
    const embed3 = createEmbed([
      {
        ...
        value: `**Discord Api Wrapper**: v${version} ([discord.js](https://discord.js.org/))\n**NodeJs Version**: v${process.version.slice(
          1
